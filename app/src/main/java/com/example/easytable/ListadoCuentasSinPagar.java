...
public class ListadoCuentasSinPagar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vista_listado_cuentas_sin_pagar);

        //Instanciacion del Recycler View
        mRecyclerViewCuentas = findViewById(R.id.recyclerViewRecibirCuentasSinPagar);
    ...
    private void onClickCuenta() {
        mCuentasAdapter.setOnItemClickListener(new CuentasAdapter.OnItemClickListener() {
            ...
            public void onItemClick(DocumentSnapshot documentSnapshot, int posicion) {
                Intent i = new Intent(ListadoCuentasSinPagar.this, DetallesCuenta.class);
                ...
                startActivity(i);
                Toast.makeText(ListadoCuentasSinPagar.this, idCuenta, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void recyclerViewCuentas(String idDelLocal) {
        ...
        Query query = db.collection("cuenta")
                .whereEqualTo("idDelLocal", idDelLocal).whereEqualTo("pagado", false);
