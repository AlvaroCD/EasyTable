...
public class ListadoCuentasPD extends AppCompatActivity {
    ...
    private void onClickCuenta() {
        mCuentasAdapter.setOnItemClickListener(new CuentasAdapter.OnItemClickListener() {
            ...
            public void onItemClick(DocumentSnapshot documentSnapshot, int posicion) {
                Intent i = new Intent(ListadoCuentasPD.this, DetallesCuenta.class);
                ...
                startActivity(i);
                Toast.makeText(ListadoCuentasPD.this, idCuenta, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void recyclerViewCuentas(String idDelLocal) {
        ...
        Query query = db.collection("cuenta")
                .whereEqualTo("idDelLocal", idDelLocal).whereEqualTo("pagado", true).whereEqualTo("efectivo", false);
